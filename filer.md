...
Testversion med stöd för bluetooth finns [här][rpi3-bttest]. Fungerar med Zwift, men inte med t ex Polar V650 (än). Denna version sänder både ANT+ och bluetooth.
